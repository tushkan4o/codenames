...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: 'Как работает режим Капитана?',
    answer: 'Вы видите поле с цветными словами. Выберите красные слова, которые хотите загадать, придумайте подсказку (одно слово + число загаданных слов) и отправьте её. Другие игроки будут угадывать слова по вашей подсказке.',
  },
  {
    question: 'Как работает режим Разведчика?',
    answer: 'Вы получаете подсказку (слово + число) от другого игрока. Нажимайте на слова, которые, по-вашему, связаны с подсказкой. За каждое красное слово +1 балл, за синее -1 балл. Чёрное слово (убийца) обнуляет счёт.',
  },
  {
