...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: 'Как в это играть?',
    answer: 'Правила и примеры есть в разделе «Обучение» на главной странице — там всё наглядно показано.',
  },
  {
  ...
  },  
  {
    ...
    answer: [
      ...
      '[75-й перцентиль cчёта всех решений подсказки] × 20 + [средний счёт] × 20 − [количество решафлов] × 10',
      'Подсказки с 3 и более решениями начинают учитываться в расчете рейтинга капитана.',
      '',
      'Рейтинг решения (разведчик):',
      'Базовый райтинг 120 + [счёт решения] × 40 − [рейтинг подсказки без штрафа за решафлы]',
      'Чем больше счёт вашего решения по сравнению с решениями других игроков — тем выше рейтинг.',
      '',
      'Рейтинг игрока:',
      ...
      'Для отображения игрока в общем рейтинге должно быть сыграно минимум 20 рейтинговых игр.',
      'Для рейтинга капитана - 5 рейтинговых подсказок, для разведчика - 20 решений.',
    ].join('\n'),
  },
];
