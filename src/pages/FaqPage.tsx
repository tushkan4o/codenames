...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      'Для отображения игрока в рейтинге должно быть сыграно минимум 3 рейтинговых игры.',
      'В дальнейшем минимальное количество игр будет увеличено, а также будет введена инфляция рейтинга.',
    ].join('\n'),
  },
];
