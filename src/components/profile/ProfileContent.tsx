      ...
      <div className="flex flex-col flex-1 min-h-0">
        ...
        {tab === 'given' && (
          cluesGiven.length === 0 ? (
            ...
            <>
            <div className="grid grid-cols-[1fr_3.5rem_2rem_2rem] sm:grid-cols-[1fr_9rem_3.5rem_2rem_2rem] gap-x-2 px-4 pr-[22px] py-1 items-center">
        ...
        {tab === 'solved' && (
          solvedEntries.length === 0 ? (
            ...
            <>
            <div className="grid grid-cols-[1fr_3rem_2rem_2rem] sm:grid-cols-[1fr_9rem_3rem_3.5rem_2rem_2rem] gap-x-2 px-4 pr-[22px] py-1 items-center">
